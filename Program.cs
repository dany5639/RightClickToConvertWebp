    ...
    internal static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var debugargs = new string[] {
                @"E:\_fast\Various\Asta\IMG\memes\cats\aMVwoDG_460swp.webp",
                @"E:\_fast\Various\Asta\IMG\memes\cats\aMVwoDG_460swp.webp",
                @"E:\_fast\Various\Asta\IMG\memes\cats\azxrwDz_460swp.webp",
                @"E:\_fast\Various\Asta\IMG\memes\cats\aPAMVNP_700bwp.webp",
                @"E:\_fast\Various\Asta\IMG\memes\cats\a9yW4b6_700bwp.webp",
                @"E:\_fast\Various\Asta\IMG\memes\cats\a87pvDY_700bwp.webp"  };
            ...
            try
            {
                ...
                foreach (var arg in args)
                {
                    ...
                    newpath = $"{fileInfo.DirectoryName}\\{filename.Substring(0, filename.Length - ext.Length)}_converted.jpg";
